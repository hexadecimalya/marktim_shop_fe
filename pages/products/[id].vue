<template>
    ...
    <div class="lg:container sm:mt-8 mx-auto p-4  ">
        <h1 class="font-semibold"> Загальна інформація</h1>
        <div v-if="product.product.description" class="border-t-2 mt-2 py-2 text-justify">{{ product.product.description_ukr }}</div>
        <div v-else class="border-t-2 mt-2 py-2 text-justify">{{ productDescription }}</div>
