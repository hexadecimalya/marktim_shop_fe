<template>
    <div v-if="!pending && product.product"
        ...
        <div class="lg:container sm:mt-8 mx-auto p-4">
            ...
            <div v-if="product.product.description_ukr" v-html="product.product.description_ukr"
                class="mt-2 py-2 text-justify">
...
const items = computed(() => [
    ...
    { label: product.value?.product?.name_ukr || product.value?.product?.name }
])
